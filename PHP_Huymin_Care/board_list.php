  ...
  <body>
    ...
    <main>
      <div>
        ...
        ?>
        <form class="" action="/board_delete.php" method="post">
          <table id="board">
            <thead>
              <tr id="field">
            ...
            <tbody>
              <?php foreach($list as $row) : ?>
                <tr>
                  ...
                  <td><a href="/board_write.php?id=<?= $row['idx'] ?>"><?= $row['title'] ?></a></td>
        ...
        <div class="center">
          ...
          <?php endfor ?>
          <button type="button" name="button" onclick="location.href='/board_write.php'">글 작성</button>
        </div>
