        ...
        <?php
          try {
            ...
            <?php if((int)$id > 0): ?>
              ...
              <form class="" action="/video_board_writeok.php?id=<?= $board['idx'] ?>" method="post" enctype="multipart/form-data">
            ...
            <?php else : ?>
              <form class="" action="/video_board_writeok.php" method="post" enctype="multipart/form-data">
