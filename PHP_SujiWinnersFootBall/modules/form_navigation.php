        ...
        <tr>
          ...
          <td class="hamberger">
            ...
            <div class="sidebar">
              ...
              <label for="subbtn2">교육과정</label>
              <ul>
                <li><a href="?p=3#sub2">교육과정</a></li>
              </ul>
              ...
              <ul>
                ...
                <li><a href="?p=6">사진 갤러리</a></li>
                <li><a href="?p=8">동영상 갤러리</a></li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <a href="?p=6"><li>사진 갤러리</li></a>
                  <a href="?p=8"><li>동영상 갤러리</li></a>
...
<?php elseif(AdminPage()) : ?>
  <nav>
    ...
    <div class="list">
      ...
      <a href="/video_board_list.php">동영상 갤러리 관리</a>
      <a href="/gallery_list.php">사진 갤러리 관리</a>
